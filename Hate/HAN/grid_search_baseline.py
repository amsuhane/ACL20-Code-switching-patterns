            ...
            for l in combined_layer_size:
                for late_mode in Late_Incorp_Modes:
                    for data_file in data_files:
                        os.system("python2 training_hate_HAN_baseline_char_level_1.py "+str(i)+" "+str(k)+" "
                                    +str(j)+" "+str(l)+" "+str(late_mode)+" "+str(Op_file)+" "+str(data_file))
                        print("python2 training_hate_HAN_baseline_char_level_1_.py "+str(i)+" "+str(k)+" "
                                    +str(j)+" "+str(l)+" "+str(late_mode)+" "+str(Op_file)+" "+str(data_file))                    
                        #exit(0)
gc.collect()
